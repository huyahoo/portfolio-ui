...
function normalizeNamespace(fn) {
  return function() {
    ...
    var _ref = typeof params[0] === "string" ? [].concat(params) : [""].concat(params), _ref2 = _slicedToArray(_ref, 4), namespace = _ref2[0], map = _ref2[1], getterType = _ref2[2], mutationType = _ref2[3];
...
function updateField(state, _ref3) {
  var path = _ref3.path, value = _ref3.value;
...
var createHelpers = function createHelpers2(_ref4) {
  var _ref5;
  var getterType = _ref4.getterType, mutationType = _ref4.mutationType;
...
//# sourceMappingURL=vuex-map-fields.js.map
